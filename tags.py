            ...
            if file.endswith(".mp3"):
                ...
                try:
                    ...
                    if "TPE1" in meta.keys():
                        ...
                        print(f"Lead performer(s)/Soloist(s)")
                        print(f"TPE1:    {track}")

                    if "TPE2" in meta.keys():
                        track = ftags.tags["TPE2"]
                        print(f"Band/orchestra/accompaniment ")
                        print(f"TPE2:    {track}")

                    if "TALB" in meta.keys():
                        album = ftags.tags["TALB"]
                        print(f"Album/Movie/Show title ")
                        print(f"TALB:    {album}")

                    if "TRCK" in meta.keys():
                        track = ftags.tags["TRCK"]
                        print(f"Track number/Position in set")
                        print(f"TRCK:    {track}")
